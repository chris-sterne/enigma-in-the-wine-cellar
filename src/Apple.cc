...
//
// This file is the Apple class implementation.  The Apple class describes
// a green apple object.
//
...
static const std::string active_name = "Apple_A.msh";
static Enigma::Mesh active_mesh;

static const std::string thumbnail_name = "Apple.png";
static Glib::RefPtr<Gdk::Pixbuf> thumbnail_pixbuf;

static const std::string singular_name_string = _("Green Apple");
static const std::string plural_name_string   = _("Green Apples");
...
void Enigma::Apple::render(const Enigma::FineLocation& viewer)
{		
...
Glib::RefPtr<Gdk::Pixbuf> Enigma::Apple::thumbnail()
{
...
const std::string& Enigma::Apple::singular_name()
{
...
const std::string& Enigma::Apple::plural_name()
{
