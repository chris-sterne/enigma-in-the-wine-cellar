...
//
// This file is the CorkScrew class implementation.  The CorkScrew class
// describes a bottle corkscrew object.
//
...
static const std::string active_name = "CorkScrew_A.msh";
static Enigma::Mesh active_mesh;

static const std::string thumbnail_name = "CorkScrew.png";
static Glib::RefPtr<Gdk::Pixbuf> thumbnail_pixbuf;

static const std::string singular_name_string = _("Bottle CorkScrew");
static const std::string plural_name_string   = _("Bottle CorkScrews");

//--------------------------------
// This method is the constructor.
//--------------------------------

Enigma::CorkScrew::CorkScrew()
{
	// Customize base class data.
	
	m_id = Enigma::Object::ID::CORKSCREW;
}
...
void Enigma::CorkScrew::render(const Enigma::FineLocation& viewer)
{		
...
Glib::RefPtr<Gdk::Pixbuf> Enigma::CorkScrew::thumbnail()
{
...
const std::string& Enigma::CorkScrew::singular_name()
{
...
const std::string& Enigma::CorkScrew::plural_name()
{
...
void Enigma::CorkScrew::initialize()
{
