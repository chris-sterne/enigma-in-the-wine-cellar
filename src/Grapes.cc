...
//
// This file is the Grapes class implementation.  The Grapes class describes
...
static const std::string active_name = "Grapes_A.msh";
static Enigma::Mesh active_mesh;

static const std::string thumbnail_name = "Grapes.png";
static Glib::RefPtr<Gdk::Pixbuf> thumbnail_pixbuf;

static const std::string singular_name_string = _("Bunch of Grapes");
static const std::string plural_name_string   = _("Bunches of Grapes");

//--------------------------------
// This method is the constructor.
//--------------------------------

Enigma::Grapes::Grapes()
{
	// Customize base class data.
	
	m_id = Enigma::Object::ID::GRAPES;
}
...
void Enigma::Grapes::render(const Enigma::FineLocation& viewer)
{		
...
Glib::RefPtr<Gdk::Pixbuf> Enigma::Grapes::thumbnail()
{
...
const std::string& Enigma::Grapes::singular_name()
{
...
const std::string& Enigma::Grapes::plural_name()
{
