...
//
// This file is the LadderEnd class header.  A LadderEnd object is
...
#ifndef __ENIGMA_LADDEREND_H__
#define __ENIGMA_LADDEREND_H__
...
namespace Enigma
{
	class LadderEnd : public Enigma::Object
	{
		public:
			// Public methods.
