...
//
// This file is the WineGlass class implementation.  The WineGlass class
// describes a wine glass object.
//
...
static const std::string active_name = "WineGlass_A.msh";
static Enigma::Mesh active_mesh;

static const std::string thumbnail_name = "WineGlass.png";
static Glib::RefPtr<Gdk::Pixbuf> thumbnail_pixbuf;

static const std::string singular_name_string = _("Wine Glass");
static const std::string plural_name_string   = _("Wine Glasses");

//--------------------------------
// This method is the constructor.
//--------------------------------

Enigma::WineGlass::WineGlass()
{
	// Customize base class data.
	
	m_id = Enigma::Object::ID::WINEGLASS;
}
...
void Enigma::WineGlass::render(const Enigma::FineLocation& viewer)
{		
...
Glib::RefPtr<Gdk::Pixbuf> Enigma::WineGlass::thumbnail()
{
...
const std::string& Enigma::WineGlass::singular_name()
{
...
const std::string& Enigma::WineGlass::plural_name()
{
...
void Enigma::WineGlass::initialize()
{
